...
interface Props { users: UserAccount[]; readingLogs: UserReadingActivity[]; searchQuery: string; onSearchQueryChange: (value: string) => void; onExportCsv: () => void; }
export function UsersTab({ users: userList, readingLogs, searchQuery: userSearchQuery, onSearchQueryChange, onExportCsv: handleExportUsersCSV }: Props) { return (
