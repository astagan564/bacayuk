...
export const ParentLoginModal: React.FC<ParentLoginModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="reader-modal w-full max-w-lg rounded-[1.35rem] p-6 sm:p-8 relative overflow-hidden flex flex-col gap-6">
        <div className="flex items-start justify-between pb-3 border-b reader-divider">
          ...
          <button
            ...
            className={`p-2 rounded-full hover:bg-black/10 transition-colors ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
            title="Tutup modal"
          >
            <X className="w-6 h-6" />
          </button>
